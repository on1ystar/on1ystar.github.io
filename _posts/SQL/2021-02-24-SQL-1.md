...
SELECT DATETIME, YEAR(DATETIME), MONTH(DATETIME), DAY(DATETIME), HOUR(DATETIME), MINUTE(DATETIME)
FROM ANIMAL_OUTS
```

<img src="{{'public/img/sql/sql-1-8.png'}}">

출처: [프로그래머스-SQL 고득점 Kit](https://programmers.co.kr/learn/courses/30/lessons/59412)

<br>

<div class="text-to-center" style="margin: 36px 0"><h2>🔷 변환(치환) 함수 🔷</h2></div>
